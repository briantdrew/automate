#! /usr/bin/env python3
# the above line ensures that python3 is used 
import pprint
...
'''
count = {} # example of the key value 'r': 12

for character in message.upper(): # change all to UPPER case so doesn't sort separately
    count.setdefault(character, 0) # set each character count to 0
